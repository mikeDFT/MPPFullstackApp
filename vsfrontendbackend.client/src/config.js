...
const VITE_SERVER_IP = (import.meta.env && import.meta.env.VITE_SERVER_IP) || "vsfrontendbackend-backend-ggf8amawbgfub6a9.westeurope-01.azurewebsites.net";
const VITE_SERVER_HTTP_PORT = (import.meta.env && import.meta.env.VITE_SERVER_HTTP_PORT) || 443;

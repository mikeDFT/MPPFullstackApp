...
export const SERVER_HTTP_URL = "https://vsfrontendbackend-backanddb-ekehbedufmaybzas.germanywestcentral-01.azurewebsites.net/"; // Full Azure backend URL for direct API calls

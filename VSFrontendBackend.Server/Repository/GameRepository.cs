...
public class GameRepository : IGameRepository
{
    private static List<Game> _games = [
        new Game(1, "Game 1", "ROR2Icon", 100, 4.5, "Description 1", ["COOP", "Roguelike"], ["PC", "Android", "Xbox"]),
        new Game(2, "Game 2", "DBDIcon", 200, 4.2, "Description 2", ["FPS", "Horror"], ["PC", "Android", "Xbox"]),
        new Game(3, "Game 3", "DBDIcon", 300, 4.7, "Description 3", ["FPS", "Roguelike"], ["PC", "PlayStation", "Xbox"]),
        new Game(4, "Game 4", "ROR2Icon", 400, 4.3, "Description 4", ["FPS", "Horror"], ["PC", "Xbox"]),
        new Game(5, "Game 5", "DBDIcon", 500, 4.8, "Description 5", ["FPS", "Roguelike"], ["Android", "Xbox"]),
    ];
